...
export const buttonVariants = cva(
    'active:scale-95 inline-flex items-center justify-center rounded-md ' +
    'text-sm font-medium transition-color focus:outline-none focus:ring-2 ' +
...
// whatever props we pass to the button is going to include the props from the button html element
